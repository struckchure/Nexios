...
class Nested(Field):
    """Allows you to nest a :class:`Schema <.Schema>`
    inside a field.
    ...
    When passing a `Schema <.Schema>` instance as the first argument,
    ...
    you should pass a `Schema <.Schema>` class (not an instance) as the first argument.
...
class Pluck(Nested):
    ...
    Example: ::
        ...
        from nexio.validation import Schema, fields
        ...
        if keys is None:
            ...
            try:
                ...
                raise ValueError(
                    ...
                    "nexio.contrib.validator.base.FieldABC."
                ) from error
