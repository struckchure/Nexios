"""Exception classes for validation-related errors."""
...
class StringNotCollectionError(BaseValidationError, TypeError):
    """Raised when a string is passed when a list of strings is expected."""


class FieldInstanceResolutionError(BaseValidationError, TypeError):
