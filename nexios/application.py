...
class NexioApp:
    ...
    def add_middleware(
        self, 
        middleware: Annotated[MiddlewareType, Doc("A callable middleware function that processes requests and responses.")]
    ) -> None:
        """
    ...
    def mount_ws_router(
        self, 
        router: Annotated["WSRouter", Doc("An instance of Router containing multiple routes to be mounted.")]
    ) -> None:
        """
        Mounts a router and all its routes to the application.
    ...
    def add_ws_middleware(
        ...
        middleware: Annotated[
            WsMiddlewareType, 
            Doc("A callable function that intercepts and processes WebSocket connections.")
        ]
    ) -> None:
        """
